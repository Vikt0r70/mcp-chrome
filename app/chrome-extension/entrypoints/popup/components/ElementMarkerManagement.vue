<template>
  <div class="section">
    <h2 class="section-title">{{ getMessage('elementMarkerTitle') }}</h2>
    <div class="config-card">
      <div class="status-section" style="gap: 8px">
        <div class="status-header">
          <p class="status-label">{{ getMessage('elementMarkerCurrentPageLabel') }}</p>
          <span class="status-text" style="opacity: 0.85">{{ currentUrl }}</span>
        </div>
        <div class="status-header">
          <p class="status-label">{{ getMessage('elementMarkerMarkedElementsLabel') }}</p>
      ...
      <form class="mcp-config-section" @submit.prevent="onAdd">
        <div class="mcp-config-header">
          <p class="mcp-config-label">{{ getMessage('elementMarkerAddTitle') }}</p>
        </div>
        ...
        <input
          ...
          :placeholder="getMessage('elementMarkerSelectorPlaceholder')"
          class="port-input"
        />
