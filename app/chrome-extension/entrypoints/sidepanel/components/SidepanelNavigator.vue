<template>
  ...
  >
    ...
    <button
      ...
      :title="getMessage('sidepanelNavigatorTooltip')"
    >
      <svg
          ...
          <div class="navigator-items">
            ...
            >
              ...
              <div class="navigator-item-content">
                <span class="navigator-item-title">{{ getMessage('agentChatTitle') }}</span>
                <span class="navigator-item-desc">{{ getMessage('agentChatDesc') }}</span>
              </div>
            ...
            >
              ...
              <div class="navigator-item-content">
                <span class="navigator-item-title">{{ getMessage('elementMarkerTitle') }}</span>
                <span class="navigator-item-desc">{{ getMessage('elementMarkerDesc') }}</span>
              </div>
